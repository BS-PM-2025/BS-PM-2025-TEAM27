  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sales.map((sale) => (
          <div key={sale.id} className="border rounded shadow p-4 relative">
            {sale.image && (
              <img
                src={sale.image}
                alt="sale"
            ...
            <p className="text-sm text-gray-500 italic">by {sale.business_name}</p>
            <p className="text-gray-600 mb-1">{sale.description}</p>
      ...
      {selectedSale && (
        <Dialog open onClose={() => setSelectedSale(null)} maxWidth="md" fullWidth>
          <div className="p-6 space-y-3 relative">
            ...
            <p className="text-sm italic text-gray-500">by {selectedSale.business_name}</p>
